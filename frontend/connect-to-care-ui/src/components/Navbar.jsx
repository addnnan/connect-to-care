      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {user ? (
            ...
            <Link
              to="/login"
              className="rounded-lg border border-emerald-600 bg-white px-4 py-2 text-sm font-medium text-emerald-600 transition hover:bg-emerald-50 dark:bg-slate-900 dark:hover:bg-slate-800 dark:font-medium dark:text-emerald-400 dark:hover:text-emerald-300"
            >
              Login
            </Link>
          )}
